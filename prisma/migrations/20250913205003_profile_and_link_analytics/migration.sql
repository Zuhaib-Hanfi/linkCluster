...
-- CreateIndex
CREATE UNIQUE INDEX "LinkAnalytics_linkId_clickedAt_clickerIp_key" ON "public"."LinkAnalytics"("linkId", "clickedAt", "clickerIp");

-- CreateIndex
CREATE INDEX "ProfileAnalytics_visitedAt_userId_idx" ON "public"."ProfileAnalytics"("visitedAt", "userId");

-- AddForeignKey
ALTER TABLE "public"."LinkAnalytics" ADD CONSTRAINT "LinkAnalytics_linkId_fkey" FOREIGN KEY ("linkId") REFERENCES "public"."Link"("id") ON DELETE CASCADE ON UPDATE CASCADE;
